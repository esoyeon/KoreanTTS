...
class DataFeederTacotron2(threading.Thread):
    ...
    def _enqueue_next_group(self):
        ...
        n = self.batch_size   # 32  --> # 16으로 수정. jy
...
if __name__ == '__main__':
    ...
    data_dirs=['/content/drive/My Drive/stt플젝/data/inna']
    #mydatafeed =  DataFeederTacotron2(coord, data_dirs, hparams, config, 32,data_type='train', batch_size=config.batch_size)
    mydatafeed =  DataFeederTacotron2(coord, data_dirs, hparams, config, 16,data_type='train', batch_size=config.batch_size)
